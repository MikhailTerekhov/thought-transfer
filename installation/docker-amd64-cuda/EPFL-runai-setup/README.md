...
3. Clone your repository in your PVC.
   ...
   mkdir thought-transfer
   git clone <HTTPS/SSH> thought-transfer/dev
   git clone <HTTPS/SSH> thought-transfer/run
   ```
   ...
   ```bash
   cd thought-transfer/dev && git config core.filemode false
...
...
[TEMPLATE INFO] PROJECT_ROOT_AT is set to /claire-rcp-scratch/home/moalla/thought-transfer/dev.
[TEMPLATE INFO] Expecting workdir to be /claire-rcp-scratch/home/moalla/thought-transfer/dev.
[TEMPLATE INFO] Installing the project with pip.
[TEMPLATE INFO] Expecting /claire-rcp-scratch/home/moalla/thought-transfer/dev to be a Python project.
[TEMPLATE INFO] To skip this installation use the env variable SKIP_INSTALL_PROJECT=1.
Obtaining file:///claire-rcp-scratch/home/moalla/thought-transfer/dev
  Installing build dependencies: started
  ...
  Building editable for thought-transfer (pyproject.toml): started
  ...
Successfully built thought-transfer
Installing collected packages: thought-transfer
Successfully installed thought-transfer-0.0.1
...
3. Then follow the instructions [here](https://www.jetbrains.com/help/pycharm/remote-development-a.html#gateway) and
   ...
   something like `/claire-rcp-scratch/home/moalla/thought-transfer/dev`).
...
4. Otherwise, your container prints a link to the IDE that you can find it its logs.
   ...
   ```bash
    Gateway link: jetbrains-gateway://connect#idePath=%2Fclaire-rcp-scratch%2Fhome%2Fmoalla%2Fremote-development%2Fpycharm&projectPath=%2Fclaire-rcp-scratch%2Fhome%2Fmoalla%2Fthought-transfer%2Fdev&host=127.0.0.1&port=2223&user=moalla&type=ssh&deploy=false&newUi=true
    ```
